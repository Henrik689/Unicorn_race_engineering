...
\hyphenation{hvem hvad hvor}				% Fortæller latex hvordan den må dele et ord; kun relevant hvis et
											% ord bliver delt forkert.
...
\newcommand{\degree}{\ensuremath{^\circ}}	% Gør det muligt at skrive \degree for at lave gradtegnet
\newcommand{\g}{\ensuremath{\cdot}}			% \g istedet for \cdot
\newcommand{\sq}{\ensuremath{^2}}			% opløfter i anden
